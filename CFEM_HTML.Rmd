...
#### Distribuição do total de municípios por Estado segundo o recebimento ou não de CFEM. 2015-2020.
```{r fim7, echo=FALSE}
...
#### Distribuição da proporção de municípios por Estado segundo o recebimento ou não de CFEM. 2015-2020.
```{r fim10, echo=FALSE}
...
labs(title = "Proporção por Estado dos municípios que distribuem ou não CFEM.2015-2020.", x = " ",y = "Proporção")
...
##Investimentos per capita versus distribuição de CFEM
...
\newpage
## Investimentos per capita versus Unidade da Federação
...
\newpage
O gráfico de envelepe indica o bom ajuste dos dados ao modelo.
...
ggplot(aes(x = UF, y = Total)) + geom_col(fill="#FF6666",position = "dodge")+   
geom_text(aes(label = Total), vjust = 1,size = 2) + theme_bw() + 
labs(title = "Total de municípios  analisado por Estado. 2015-2020. Antes do ajuste do intervalo ", x = " ",y = "Total")

base2$UF[base2$UF == "A_MG"] <- "MG"
base2 %>% group_by(UF) %>% summarise(Total = n()) %>% 
ggplot(aes(x = UF, y = Total)) + geom_col(fill="#FF6666",position = "dodge")+   
geom_text(aes(label = Total), vjust = 1,size = 2) + theme_bw() + 
labs(title = "Total de municípios  analisado por Estado. 2015-2020. Após o ajuste do intervalo ", x = " ",y = "Total")
```
...
labs(title = "Proporção por Estado dos municípios na base completa e na intervalar.2015-2020.", x = " ",y = "Proporção")
